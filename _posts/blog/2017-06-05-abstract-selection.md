...
![FOSS4G Presentation Abstracts: Program Committee Review]({{ site.baseurl }}/images/image2_blog.png){: .not}
...
![Origins of Accepted Presenters]({{ site.baseurl }}/images/image4_blog.png){: .not}
